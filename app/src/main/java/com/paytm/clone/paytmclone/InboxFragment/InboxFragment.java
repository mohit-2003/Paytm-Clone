package com.paytm.clone.paytmclone.InboxFragment;
...
import com.paytm.clone.paytmclone.NavigationDrawer.DrawerListAdapter;
import com.paytm.clone.paytmclone.NavigationDrawer.NavItem;
...
public class InboxFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = view.findViewById(R.id.toolbar_inbox);
